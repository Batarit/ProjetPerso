...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 04 déc. 2023 à 16:14
...
INSERT INTO `friendlist` (`id`, `idP1`, `idP2`) VALUES
(5, 7, 1),
(6, 9, 6),
(7, 8, 7),
(8, 1, 8),
...
INSERT INTO `guildes` (`nom`, `description`, `id`) VALUES
('adadadada', '', 1);
...
(1, 'jack', 1, 0, 100, 100, 5, 0, 3, 1, NULL, NULL, 3),
...
ALTER TABLE `friendlist`
  ADD CONSTRAINT `friendlist_ibfk_1` FOREIGN KEY (`idP1`) REFERENCES `perso` (`id`),
  ADD CONSTRAINT `friendlist_ibfk_2` FOREIGN KEY (`idP2`) REFERENCES `perso` (`id`);
