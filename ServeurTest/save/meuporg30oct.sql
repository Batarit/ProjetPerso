...
CREATE TABLE IF NOT EXISTS `perso` (
  ...
  `logued` int(11) NOT NULL,
  `id player` int(11) NOT NULL,
  `id race` int(11) NOT NULL,
  `id passif` int(11) NOT NULL,
  `id guild` int(11) NOT NULL,
  `id map` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id race` (`id race`),
...
(1, 'Nain', 3, -2, 2, 'une espece robuste mais plut̫t faible en magie'),
